...
export const Icons = {
  ...
  Lotus: (props: any) => (
    <img src="logo.png" alt="Senay Logo" {...props} style={{ filter: 'brightness(0) saturate(100%) invert(80%) sepia(35%) saturate(769%) hue-rotate(3deg) brightness(92%) contrast(88%)', ...props.style }} />
  ),
  Logo: (props: any) => (
    <img src="logo.png" alt="Senay Logo" {...props} />
  ),
