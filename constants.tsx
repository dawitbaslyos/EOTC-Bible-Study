...
export const Icons = {
  ...
  Lotus: () => (
    <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><path d="M12 2L9 8h6L12 2z"/><path d="M12 22l-3-6h6l-3 6z"/><path d="M2 12l6-3v6l-6-3z"/><path d="M22 12l-6-3v6l6-3z"/><circle cx="12" cy="12" r="3"/></svg>
  ),
  Book: () => (
  ...
  Cloud: () => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M17.5 19x2a4.5 4.5 0 0 1 0-9h-.7A7 7 0 1 0 5 13.1v.1a4.5 4.5 0 0 0 0 9h12.5Z"/></svg>
  ),
  Attach: () => (
